...
model = rbind(model_E1, model_E2)  # model_E0,  
...
ggsave(plot, file="figures/analyze_ModelIncludingNoTP_PlotForExpt2_Joint_ModelHuman_R.pdf", width=15, height=6)
...
ggsave(plot, file="figures/analyze_ModelIncludingNoTP_PlotForExpt2_Joint_ModelHuman_Corrs_R.pdf", width=15, height=6)
