...
predictors = c("MarginalNoun.C", "Log_SC_Bias.C", "HomophoneVerb.C", "Deverbal.C", "LogSubjectBias.C", "Marginal_ukwac.C", "Marginal_COCA.C", "NounLength.C")
for(iter in (1:50)) {
...
sink("output/analyze_Previous_BIC_NoEmbeddingBias.R.txt")
