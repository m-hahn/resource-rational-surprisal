...
sink("output/analyze.R_wikipedia.txt")
print(summary(model))
sink()

write.table(summary(model)$fixed, file="output/analyze.R_fixed_wikipedia.tsv", sep="\t")
...
ggsave(plot, file="figures/posterior-histograms-main_effects_wikipedia.pdf", width=5, height=5)
...
ggsave(plot, file="figures/posterior-histograms-interactions_wikipedia.pdf", width=5, height=5)
...
ggsave(plot, file="figures/posterior-histograms_wikipedia.pdf", width=5, height=4)
...
ggsave(plot, file="figures/posterior-histograms-EmbeddingBias_wikipedia.pdf", width=5, height=5)


sink("output/analyze.R_posteriors_wikipedia.txt")
...
ggsave(plot, file="figures/posterior-histograms-RawEffects_EmbeddingBias_wikipedia.pdf", width=5, height=3)
