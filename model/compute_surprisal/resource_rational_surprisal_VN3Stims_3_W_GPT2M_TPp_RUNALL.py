...
script = "char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_Subseq_VeryLong_WithSurp12_NormJudg_Short_Cond_Shift_NoComma_Bugfix_VN3Stims_3_W_GPT2M_TPp.py"
...
for model in models:
   ...
   resultsPath = f"/u/scr/mhahn/reinforce-logs-both-short/full-logs-retentionProbs/{script}_{ID}"
