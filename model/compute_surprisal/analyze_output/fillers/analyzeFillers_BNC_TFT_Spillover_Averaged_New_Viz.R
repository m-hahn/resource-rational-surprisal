...
data = read.csv("output/analyzeFillers_freq_BNC_TFT_Spillover_Averaged_New_R.tsv", sep="\t") %>% filter(NData == 7271)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_TFT_Spillover_Averaged_New_R.pdf", height=2, width=5)
