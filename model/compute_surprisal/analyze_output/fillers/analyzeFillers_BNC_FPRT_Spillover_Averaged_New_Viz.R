...
Datapoints = 7271
data = read.csv("output/analyzeFillers_freq_BNC_FPRT_Spillover_Averaged_New_R.tsv", sep="\t")
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_FPRT_Spillover_Averaged_New_R.pdf", height=2, width=5)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_FPRT_Spillover_Averaged_New_R_Lambda1.pdf", height=2, width=5)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_FPRT_Spillover_Averaged_New_R_Lambda1_Integer.pdf", height=1.8, width=5)
