...
with open("char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_Subseq_VeryLong_WithSurp12_NormJudg_Short_Cond_Shift_NoComma_Bugfix_VN3Stims_3_W_GPT2M_TPS.py.tsv", "r") as inFile:
 ...
 for data in datas:
  ...
  #os.symlink("TMP", "TMP2")
  print(f"/u/scr/mhahn/ZENODO_RESRAT/pred_{predictability_weight}_del_{deletion_rate}_full/{filename}")
#  quit()
  os.symlink(path[0], f"/u/scr/mhahn/ZENODO_RESRAT/pred_{predictability_weight}_del_{deletion_rate}_full/{filename}")
#  quit()
